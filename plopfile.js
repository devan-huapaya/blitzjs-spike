...
module.exports = (plop) => {
  ...
  plop.setGenerator("component", {
    ...
    prompts: [
      ...
      // 			const exists =
      // 				fs
      // 					.readdirSync(path.join(__dirname, `app/components/${componentType}`))
      // 					.indexOf(value) >= 0
    ...
    actions: ({ componentType, name }) => {
      ...
      const actions = [
        {
          ...
          type: "add",
          path: "./app/components/{{componentType}}/{{properCase name}}/index.ts",
        ...
        },
        {
          ...
          type: "add",
          path: "./app/components/{{componentType}}/{{properCase name}}/{{properCase name}}.tsx",
          templateFile:
            componentType === "pages"
        ...
        },
        {
          ...
          type: "add",
          path: "./app/components/{{componentType}}/{{properCase name}}/{{properCase name}}.types.ts",
        ...
        },
        {
          ...
          type: "add",
          path: "./app/components/{{componentType}}/{{properCase name}}/{{properCase name}}.styled.ts",
        ...
        },
        {
          ...
          type: "add",
          path: "./app/components/{{componentType}}/{{properCase name}}/{{properCase name}}.spec.tsx",
      ...
      if (componentType === "pages") {
        actions.push({
          ...
          type: "add",
          path: "./app/pages/{{lowerCase name}}.tsx",
